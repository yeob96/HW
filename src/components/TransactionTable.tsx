...
function TransactionRow({ t, dealType, liked, disliked, onSwipeLike, onSwipeDislike }: TransactionRowProps) {
  ...
  useEffect(() => {
    if (!dragging) return
    const handleMove = (e: PointerEvent) => setDragX(clampDragForState(e.clientX - startX.current))
    const handleUp = (e: PointerEvent) => {
      const delta = clampDragForState(e.clientX - startX.current)
      setDragging(false)
  ...
  }, [dragging, onSwipeDislike, onSwipeLike, liked, disliked])
